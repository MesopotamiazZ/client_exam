...
<template>
  <div class="basicInformationOuterBox">
    <div class="basicInfo">
      ...
      <div class="quoteGbz" v-if="showGbzEntry">
...
//        console.log(data, '--=-=')
        ...
        this.targetDisease = this.getter(data, '')
        this.radiationCategory = this.getter(data, 'radiation.category')
        this.spacial = this.getter(data, 'specialCondition')
        this.radiationDisease = this.getter(data, 'radiation.targetDisease')
