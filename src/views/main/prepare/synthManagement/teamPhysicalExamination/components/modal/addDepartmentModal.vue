...
*/
<template>
<div v-if='addDepartmentModal'>
  <Modal v-model="addDepartmentModal"
         ...
         :closable="false">
    <div slot="header">
      <alert-header :showInput='false' :headerText="'新增车间/部门'"></alert-header>
    </div>
    <div class="content">
...
export default {
  ...
  methods: {
    ...
    /* ========================================================弹窗操作 */
    sure() {
      this.$emit('add-department-save')
    },
    cancel() {
      this.$emit('update:addDepartmentModal', false)
    },
