...
*/ 
<template>
  <div class="healthyExamRemarkInvoices" v-if="controlModal">
    <Modal v-model="controlModal"
      ...
      <div slot="header">
        <p name='alertHeader'
          ...
          <span class="alertHeaderText font16">健康体检备单</span>
        </p>
      </div>
      <div class="main">
    ...
    <healthySet :healthySetModal="healthySetModal" @send="healthySetModal=false" @cancel="healthySetModal=false"></healthySet>
    <!-- 删除 -->
    <affirm-del-modal
      :isMask="false"
...
import healthySet from './healthySet'
export default {
  name: 'healthyExamRemarkInvoices',
  components: {
    dateComponent,
    zInput,
    ZTable,
            ...
            return h('z-input', {
              ...
              on: {
                'on-blur': function(event) {
                  params.row.personalPercent = event.target.value
