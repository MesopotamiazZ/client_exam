      ...
      <div class="content-wrapper">
        <div class="detail-form-wrapper">
          <Form ref="detailForm"
            ...
            <ul>
              <li class="first-row">
                <FormItem label="单位结算单号"
                          prop="unitStatementNo"
                          class="detail-form-row">
                  <Input type="text"
                         v-model.trim="detailForm.data.unitStatementNo"
                         disabled></Input>
                </FormItem>
                <FormItem label="单位体检号"
                          ...
                          class="detail-form-row">
                  <Input type="text"
                         v-model.trim="detailForm.data.unitExamId"
                         disabled></Input>
                </FormItem>
                <FormItem label="单位名称"
                          prop="unit"
                          class="detail-form-row">
                  <Input type="text"
                         v-model.trim="detailForm.data.unit"
                         disabled></Input>
                </FormItem>
              </li>
              <li class="second-row">
                ...
                <FormItem label="结算时间"
                          ...
                          class="detail-form-row">
                  <Input type="text"
                         v-model.trim="detailForm.data.statementTime"
                         disabled></Input>
                </FormItem>
                <FormItem label="单位总金额"
                          prop="unitTotalAmount"
                          class="detail-form-row">
                  <Input type="text"
                         v-model.trim="detailForm.data.unitTotalAmount"
                         disabled></Input>
                </FormItem>
              </li>
              <li class="third-row">
    ...
    return {
      detailForm: {
        data: {
          ...
          trueDiscount: '80%', // 实收比例
          actualDiscount: '1000', // 实收优惠
          paymentStyle: '微信', // 支付方式
          statementAccount: '', // 结算账户
          remark: '', // 备注
          invoiceUnit: '超微半导体公司', // 发票单位
