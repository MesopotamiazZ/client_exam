...
*/
<template>
  <Modal v-model="modelReturnPay"
         class="model-return-money"
         :width='818'
         :transfer='false'
         :mask-closable="false"
         :transition-names="['']"
    ...
    <div class="content">
      ...
      <div>
        ...
        <!-- <div style="display:inline-block;">
          <div class="left-name fl">支付方式</div>
          <Input v-model="reOrder.unitOrderMoney"
                class="right-input fl"
                style="width: 318px"
                disabled/>
        </div> -->
        <!-- <div class="left-name fl" style="width:48px;">支付方式</div>
        <Input v-model="reOrder.unitOrderMoney"
               class="right-input fl"
               style="width: 294px"
               disabled/>
      ...
      <div style="margin-bottom:20px">
        <!-- <div class="right-name fl" style="width:72px;">结算账户</div>
        <Input v-model="reOrder.reMoney"
               class="right-input fl"
               style="width: 120px"
               disabled/>
        ...
        <Input v-model="reOrder.account"
               ...
               disabled/> -->
        <div style="display:inline-block;">
            <div class="left-name fl">退费原因</div>
            <Input v-model="reOrder.remark"
                class="right-input fl"
                style="width: 318px"
                disabled/>
        </div>
        <div class="left-name" style="line-height:30px;height:30px;">退款方式</div>
        <RadioGroup v-model="reOrder.reStyle" class="radio-group">
          <Radio label="现金"></Radio>
          <Radio label="退回账户"></Radio>
        </RadioGroup>
...
<style lang="less">
.model-return-money .price .ivu-input {
