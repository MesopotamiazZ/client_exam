  ...
  <div class="person-charge-out"
    ...
    <div class="person-charge">
      ...
      <Modal v-model="ifShowModal"
             ...
             :closable="false">
        <div slot="header">
          <alert-header headerText="个人收费" :showInput='false'></alert-header>
        </div>
          ...
          <Form :model="showModalData"
            ...
            <ul class="charge-body-ul">
              <li class="fl marginB20 marginR20">
                <span class="charge-body-name fl textJustify marginR10">体检号</span>
                <div class="fl">
                  <Input v-model="showModalData.pe_sn" disabled></Input>
                </div>
              </li>
              <li class="fl marginB20 marginR20">
                <span class="charge-body-name fl textJustify marginR10">姓名</span>
                <div class="fl">
              ...
              <li class="fl marginB20 marginR20">
                <span class="charge-body-name fl textJustify marginR10">订单金额</span>
                <div class="fl">
              ...
              <!-- <li class="fl marginB20">
                ...
                <div class="fl">
                  ...
                  <z-input class="charge-body-percent" disabled type='number' v-model="showModalData.zk"></z-input>
                </div>
              </li> -->
              <!-- <li class="fl marginB20 marginR20">
                <span class="charge-body-name fl textJustify marginR10">减免金额</span>
                <div class="fl">
            ...
            <div style="height:30px;line-height:30px;">
              <Checkbox v-model="showUnitVip" class="font14" style="color: #111111;">账户</Checkbox>
              <div class="show-unit-vip-pay fr marginT10 marginB10" v-if='showUnitVip'>
                <div class="vip-point"></div>
                <div class="person-tab">
                  <self-tab-for-modal :tab='tab' @tab-change='tabChange'></self-tab-for-modal>
                </div>
                <div class="unit-vip-pay-content paddingT15 paddingL15 paddingB15 paddingR15">
                  <!-- 个人会员 -->
                  <ul class="charge-body-ul" v-if='showPersonVip===0'>
                    <li class="fl marginB20">
                      <span class="charge-body-name fl textJustify marginR10">账户余额</span>
                      <div class="fl" style="width: 175px;margin-right: 50px;">
                        <z-input class="self-input-price" type='number' v-model="showModalData.self_per_zhye"></z-input>
                      </div>
                    </li>
                    <li class="fl marginB20">
                      <span class="charge-body-name fl textJustify marginR10">支付密码</span>
                      <div class="fl" style="width: 175px;">
                        <Input type="password" v-model="showModalData.self_per_pasword"></Input>
                      </div>
                    </li>
                    <li class="clearBoth"></li>
                    <li class="fl check-phone-number" style="margin-right: 40px;">
                      <span class="charge-body-name-l fl textJustify marginR10"
                            style="width: 39px;">手机号:</span>
                      <div class="fl" style="line-height: 30px;width: 127px;">
                        <span style="width: 76px;">{{showModalData.self_per_phone}}</span>
                        <!-- <p class="verification-code"
                           :class="{verifiCodeDisabled:person.verifiCodeDisabled}"
                           @click="sendVeriCodePer">发送验证码</p> -->
                        <p class="verification-code" v-if='!person.verifiCodeDisabled' @click="sendVeriCodePer">发送验证码</p>
                        <span class="marginL10" v-if='person.verifiCodeDisabled'>({{ person.timeNumber }}S)</span>
                      </div>
                    </li>
                    <li class="fl">
                      <span class="charge-body-name fl textJustify marginR10" style="width: 36px;">验证码</span>
                      <div class="fl" style="width: 72px;margin-right:99px;">
                        <Input v-model="showModalData.self_per_yzNum"></Input>
                      </div>
                    </li>
                    <li class="clearBoth"></li>
                  </ul>
                  <!-- 单位会员 -->
                  <ul class="charge-body-ul" v-if='showPersonVip===1'>
                    <li class="fl marginB20">
                      <span class="charge-body-name-l fl textJustify marginR10" style="width: 72px;">单位名称</span>
                    ...
                    <li class="fr marginB20">
                      <span class="charge-body-name fl textJustify marginR10">账户余额</span>
                      <div class="fl" style="width: 175px;">
                        <z-input class="self-input-price" type='number' v-model="showModalData.self_unit_zhye">
                        </z-input>
                      </div>
                    </li>
                    ...
                    <li class="fl">
                      ...
                      <div class="fl" style="width: 201px;margin-right: 55px;">
                        <Input type="password" v-model="showModalData.self_unit_password"></Input>
                      </div>
                    </li>
                    <li class="fl check-phone-number">
                      <span class="charge-body-name-l fl textJustify marginR10" style="width: 39px;">手机号:</span>
                      <div class="fl" style="line-height: 30px;width: 127px;">
                    ...
                    <li class="fr">
                      <span class="charge-body-name-l fl textJustify marginR10" style="width: 36px;">验证码</span>
        ...
        <div slot='footer'>
          <div class="unit-charge-footer paddingB20 paddingT20">
            ...
            <Checkbox class="fr marginR20" style="line-height: 30px;"
                      v-model="showModalData.ybtm"
                      :true-value=1
                      :false-value=0>打印样本条码</Checkbox>
            <Checkbox class="fr marginR20"
                      style="line-height: 30px;"
                      v-model="showModalData.zyd"
                      :true-value=1
                      :false-value=0>打印指引单</Checkbox>
            <div class="clearBoth"></div>
          </div>
        </div>
      </Modal>
...
export default {
  ...
  data() {
    ...
    return {
      msg: '单位收费',
      // collectMoney: 0, // 待收金额合计
      // receivableMoney: 0, // 应收金额合计
      tab: [
        {
          title: '个人会员',
        },
  ...
  watch: {
    ...
    // 'showModalData.vipRechargePrice' (val) { // 确认在切换的时候这部分填入的数据是不是要清空
    //   if (val === '账户') {
    //     this.showUnitVip = true
    //   } else {
    //     this.showUnitVip = false
    //   }
    // },
  ...
  methods: {
    ...
    sendVeriCodePer() {
      ...
      // 计时数字开始
      // 计时完成之后
      this.person.verifiCodeDisabled = true
      this.showTimePer()
    },
    showTime() {
    ...
    clearPersonInertval() {
      // 清除个人会员调用
      clearInterval(this.person.setTimeInterval)
      this.person.timeNumber = this.person.timeNumberInit
      this.person.verifiCodeDisabled = false
    },
    showTimePer() {
      this.person.timeNumber = this.person.timeNumberInit
      this.person.setTimeInterval = setInterval(() => {
        this.person.timeNumber--
        if (this.person.timeNumber < 0) {
          this.clearPersonInertval()
        }
      }, 1000)
    },
