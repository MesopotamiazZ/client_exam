...
* @author 覃凤
* @date 2018/3/10
* @content 表格导入员工-表格信息-职业史信息
* showData：页面显示的数据，showIndex：页面显示的选中行
*/
<template>
  <div class="career-history-infor-staff">
...
<script>
export default {
  name: 'career-history-infor-staff',
  props: {
    showData: {
      type: Array,
      default: () => {
...
.career-history-infor-staff {
  ...
  .personnel-infor-body {
    ...
    .person-info-public {
      ...
      &>li:nth-of-type(5) { // 总工龄
        width: 100px;
      }
      &>li:nth-of-type(6) { // 接害工龄
        width: 100px;
      }
      &>li:nth-of-type(7) { // 危害因素名称1
        width: 200px;
      }
      &>li:nth-of-type(8) { // 职业健康检查种类
      width: 116px;
      }
      &>li:nth-of-type(9) { // 危害因素名称2
        width: 200px;
      }
      &>li:nth-of-type(10) { // 职业健康检查种类
        width: 116px;
      }
      &>li:nth-last-of-type(2) { // 危害因素名称3
        width: 200px;
      }
      &>li:nth-last-of-type(1) { // 职业健康检查种类
        border-right: none;
        flex: 1;
      }
    }
