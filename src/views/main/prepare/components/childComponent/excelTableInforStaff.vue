...
*/
<template>
  <div class="excel-table-infor-staff">
    ...
    <div class="content-detailed">
      <personnel-infor-staff :showData='newExcelData' :showThisRow='showThisRow' v-show='showWitchTab===0' class="person-info"></personnel-infor-staff>

      <!-- 职业史信息 -->
      <career-history-infor-staff :showData='newExcelData' v-show='showWitchTab===1' :showThisRow='showThisRow' class="occupation-info"></career-history-infor-staff>
    </div>
    <!-- 分页 -->
...
import personnelInforStaff from './personnelInforStaff' // 人员信息
import careerHistoryInforStaff from './careerHistoryInforStaff' // 职业史信息
export default {
  name: 'excel-table-infor-staff',
  components: {
    tab,
    zPage,
    personnelInforStaff,
    careerHistoryInforStaff,
  },
  props: {
    excelData: {
      type: Array,
