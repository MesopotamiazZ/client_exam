...
*/
<template>
  <div class="departmentCategoryManagement-category-wrapper">
    <!-- 主体 -->
    <div class="departmentCategoryManagement-category">
      <div class="header-wrapper">
        <div class="eap-header">
          <title-has-slot>
            <span slot="titletHasSlotLeftTitle">科室类别列表</span>
      ...
      <Modal
        ...
        <div class="add-inquiry-center">
          ...
          <div class="row clearfix">
            <span class="textJustify fl lineH30" style="width:68px;">科室类别</span>
            <FormItem prop="name" class="fr">
              <Input style="width:307px" :class='{inputRequired: isEmpty(formCustomAdd.name)}' v-model.trim="formCustomAdd.name"></Input>
            </FormItem>
          </div>
          <div class="row clearfix">
            <span class="textJustify fl lineH30" style="width:68px;margin-top:3px;">备注</span>
            <FormItem class="fr">
              <Input style="width:307px" v-model="formCustomAdd.remark" type="textarea" :row="2"></Input>
            </FormItem>
          </div>
          </Form>
        </div>
...
<script>
  ...
  import * as types from '@/store/modules/information/manageOffice/departmentCategoryManagement/departmentCategoryManagementTypes'
  import api from '@/api'
  ...
  export default {
    ...
    computed: {
      ...
      ...mapState('departmentCategoryManagementModule', ['diseaseTypesList', 'total']),
      pageInfo() {
    ...
    methods: {
      ...
      ...mapMutations('departmentCategoryManagementModule', {
        reset: types.RESET,
        setTotal: types.SET_TOTAL,
      }),
      ...mapActions('departmentCategoryManagementModule', [
        'getDiseaseTypesFunc',
        'addDiseaseTypesFunc',
      ...
      exportBtn() {
        ...
        let _this = this
        exportXlsx('科室类别管理', {
          api: api.departmentCategoryManagement.getDiseaseTypesFunc,
...
<style lang="less">
  ...
  .departmentCategoryManagement-category-wrapper {
    position: relative;
    margin: auto;
    height: 100%;

    .departmentCategoryManagement-category {
      height: 100%;
      width: 100%;
      padding: 10px;
