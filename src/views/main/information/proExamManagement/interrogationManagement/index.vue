 ...
 */
<template>
  <div class="interrogation-wrapper">
    <!-- 主体 -->
    <div class="interrogation">
      <div class="header-wrapper">
        <div class="table-header">
          <title-has-slot>
            <span slot="titletHasSlotLeftTitle">问诊症状列表</span>
        ...
        <div class="add-inquiry-center">
          <Form ref="formCustomAdd"
            ...
            <div class="row clearfix">
              <span class="textJustify fl lineH30" style="width:72px;">问诊症状名称</span>
            ...
            <div class="row clearfix">
              <span class="textJustify fl lineH30" style="width:72px;">适用性别</span>
              <FormItem prop="sex" class="fr">
                <Select
                  filterable
                  v-model="formCustomAdd.sex"
                  style="width:256px"
                  placeholder=""
                  :class="{selectionRequired:isEmpty(formCustomAdd.sex)}">
                  <Option v-for="item in toSexList" :value="item.value" :key="item.value">{{ item.label }}</Option>
                </Select>
              </FormItem>
            </div>
            <div class="row clearfix">
