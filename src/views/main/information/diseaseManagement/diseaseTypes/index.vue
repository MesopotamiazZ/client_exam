...
*/
<template>
  <div class="diseaseTypes-category-wrapper">
    <!-- 主体 -->
    <div class="diseaseTypes-category">
      <div class="header-wrapper">
        <div class="eap-header">
          <title-has-slot>
            <span slot="titletHasSlotLeftTitle">疾病类别列表</span>
            <div slot="titletHasSlotRightContent" class="titlet-slot-left">
              <Button type="ghost" v-if="selectMode" class="fr " key="2" @click="selectMode=false">取 消</Button>
      ...
      <Modal
        ...
        <div class="add-inquiry-center">
          ...
          <div class="row clearfix">
            <span class="textJustify fl lineH30" style="width:72px;">疾病类别名称</span>
...
<script>
  ...
  import * as types from '@/store/modules/information/diseaseManagement/diseaseTypes/diseaseTypes'
  import api from '@/api'
  ...
  export default {
    ...
    computed: {
      ...
      ...mapState('diseaseTypesModule', ['diseaseTypesList', 'total']),
      pageInfo() {
    ...
    methods: {
      ...
      ...mapMutations('diseaseTypesModule', {
        reset: types.RESET,
      ...
      exportBtn() {
        ...
        let _this = this
        exportXlsx('疾病类别管理', {
          api: api.diseaseTypes.getDiseaseTypesFunc,
...
<style lang="less">
  ...
  .diseaseTypes-category-wrapper {
    position: relative;
    margin: auto;
    height: 100%;

    .diseaseTypes-category {
      height: 100%;
      width: 100%;
      padding: 10px;
