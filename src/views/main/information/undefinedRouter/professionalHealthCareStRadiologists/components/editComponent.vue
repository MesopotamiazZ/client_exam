...
*/
<template>
  <div class="professionalHealthCareStRadiologists-add-modal" v-if="editModalDiv">
    ...
    <!-- 编辑弹窗 -->
      <Modal ref="modalContent"
             ...
             :closable="false">
        <div slot="header">
          <alert-header headerText="编辑放射职业健康监护技术规范"
                        :headerVal="totalsort"
          ...
          <Form ref="addForm"
            ...
            <div class="body-content"
              ...
              <div class="first">
                ...
                <div class="item2"   style="margin-top: 15px;margin-left:20px">
              ...
              <div class="third"
                ...
                <div class=" marginL20 marginT20">
                  <span class=" fl">最后修改人：{{data?data.operater:''}}</span>
        ...
        <div slot="footer" class="clearfix">
          ...
          <Button type="ghost" class="fr marginR20 marginB20" @click="saveNewItem()">取 消</Button>
          <Button class="fr marginR20 marginB20" @click="cancelNewItem">保 存</Button>
        </div>
      </Modal>
  </div>
</template>
...
export default {
  ...
  computed: {
    ...
    updated_at() {
      if (this.data && this.data.updated_at) {
        return fifters.timeFilter(this.data.updated_at, 'YYYY-MM-DD HH:mm')
      } else {
        return ''
      }
    },
  ...
  watch: {
    data: {
      handler(newData) {
        console.log('12121212', newData)
        this.addModal.data = newData
        console.log('333333', this.addModal.data)
      },
      deep: true,
    },
    sort(data) {
